    ...
    <p>
     ...
     <div class="home">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
              <h1 class="display-4 head_center">Book hub</h1>
              <p class="lead para_center">Find the book you love easily in book hub.</p>
            </div>
          </div>

            <form class="form-inline searching_inline my-2 my-lg-0">
                <input class="form-control searching mr-sm-2" type="search" placeholder="Search" aria-label="Search">
